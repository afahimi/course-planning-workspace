...
// Import generateRecommendations to make the course search more dynamic
import { generateRecommendations } from "../data/preset-data"

// Update the component to use dynamic recommendations
export function CourseSearch() {
  ...
  // Use generateRecommendations instead of a direct filter to get better matches
  const filteredCourses =
    searchTerm.trim().length > 0
      ? generateRecommendations(searchTerm, currentWorklist.courses)
      : courses.filter((course) => !currentWorklist.courses.includes(course.id)).slice(0, 8)
